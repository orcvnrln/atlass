...
import { Settings, Home, Wallet, Star, Newspaper, CalendarDays, BrainCircuit, Sparkles, LayoutGrid, Link2, Book, Layers, Flame, BarChart, Activity, Monitor } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const mainNavItems = [
    ...
    { path: '/workspace', icon: LayoutGrid, name: 'Workspace' },
    { path: '/charts', icon: BarChart, name: 'Charts' },
