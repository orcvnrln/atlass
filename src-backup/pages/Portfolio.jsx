...
import DrawdownTracker from '@/components/portfolio/DrawdownTracker';
import LiquidityScore from '@/components/portfolio/LiquidityScore';
import TaxLossHarvestingAdvisor from '@/components/portfolio/TaxLossHarvestingAdvisor';
import ConcentrationRiskAlert from '@/components/portfolio/ConcentrationRiskAlert';
import RollingSharpeRatio from '@/components/portfolio/RollingSharpeRatio';
import AllocationAdvisor from '@/components/portfolio/AllocationAdvisor';
import ESGImpactScore from '@/components/portfolio/ESGImpactScore';
import CashFlowCalendar from '@/components/portfolio/CashFlowCalendar';
import PeerBenchmarking from '@/components/portfolio/PeerBenchmarking';
...
const portfolioData = {
  summary: {
    ...
    totalReturn: 17450.32,
    totalReturnPercent: 15.86,
    bestPerformer: { symbol: 'TSLA', pnl: 789.12 },
    worstPerformer: { symbol: 'AMZN', pnl: -234.56 },
  },
  allocations: [
    { name: 'Stocks', value: 65000, color: '#4C6EF5' },
